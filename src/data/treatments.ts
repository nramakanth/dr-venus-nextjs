...
export const allTreatments: Treatment[] = [
 ...
 `,
  ...
  <section>
    ...
    <p>
      There are <a href="https://www.drvenus.in/acne-types/" 
             rel="noopener noreferrer"class="text-blue-600 underline">different types of acne scars</a> such as rolling scars (with gently sloping edges)
    </p>
  ...
  <section>
    ...
    <ul class="mt-6 space-y-4 text-gray-700">
      ...
      <li>
        ...
        This is a state of the art fractionated Erbium YAG Laser from world-renowned Alma Lasers. This works on the proven principle of ablative fractional resurfacing modality using the safest wavelength for colored Asian skin (as opposed to the more aggressive <a href="https://www.drvenus.in/co2-laser-treatment/" 
             rel="noopener noreferrer"class="text-blue-600 underline">carbon dioxide laser</a> ). Pixel is extremely effective in stimulating collagen production and improves almost all<a href="https://www.drvenus.in/types-of-scars/" 
             rel="noopener noreferrer"class="text-blue-600 underline">types of scars</a>and lines. It gives your skin a dramatically rejuvenated appearance as it encourages younger skin to emerge. The color and texture of your skin gets rid of blemishes giving it the perfect makeover. This is an almost painless procedure when combined with a numbing cream and can be completed by our dermatologist in barely 15 minutes. Sometimes a special technique called Shouldering May be done where the sharp edges of box scars are destroyed with the controlled use of erbium YAG laser in its pure ablative mode. This converts the clearly demarcated scars into those with gradually sloping cosmetically superior scars,
      ...
      <li>
           ...
           <br>If you are looking for a quick fix,</br><br>then this is right option to make you overjoyed. In this,</br>
             ...
             rel="noopener noreferrer"class="text-blue-600 underline"> Hyaluronic acid </a> which is a natural substance produced in the skin. Hyaluronic acid may stay back in the place filling up the scars for a period of 6-8 months and later it is slowly digested by the body enzymes. we use only US FDA approved fillers.<a href="https://www.drvenus.in/acne-types/" 
             rel="noopener noreferrer"class="text-blue-600 underline"><a href="https://www.drvenus.in/acne-types/" 
             rel="noopener noreferrer"class="text-blue-600 underline">.Dermal fillers</a></a> be done as a lunch hour procedure with minimal discomfort under the effect of anesthetic cream.
      </li>
  ...
  <section class="bg-accent/5 p-8 rounded-[2rem] border border-accent/10">
    ...
    <p class="text-sm">
      Our clinic locations are in <strong>Our clinic locations are in Chandanagar, Kondapur and Tolichowki which is 15 minutes drive from Kukatpally, Gachibowli, Miyapur, Hi-Tech City; 20 minutes drive from Jubilee Hills and Banjara Hills. So, don’t waste your time to book an appointment in advance.
    </p>

    <p class="mt-4 text-sm">
      Book your appointment today for safe and advanced acne scar removal treatment.
    </p>
  </section>
    ...
    },
    {
        ...
        description: "Permanent reduction of unwanted hair for smooth skin.",
        content: `
     <strong class="font-bold text-green-900"> Permanent Laser Hair Removal Treatment in Hyderabad</strong>
        ...
        <strong class="text-green-900 text-2xl">Benefits of Laser Hair Removal Treatment in Hyderabad</strong>
        ...
        <ul class="list-decimal list-inside">
          ...
          <img 
            src="https://www.drvenus.in/wp-content/uploads/2022/11/Laser-hair-removal-treatment-in-hyderabad-min-1.jpg" 
            alt="Laser Hair Removal Treatment"
            style="width:100%; max-width:900px; height:auto; margin:20px 0; border-radius:8px;"
        />

        <strong class="text-green-900 text-2xl">Full Body Laser Hair Removal Treatment</strong>
        <p>
        ...
        <h2 class="text-xl">Any Side Effects of Laser Hair Removal?</h2>
        <p>
            TLaser hair removal treatment has no severe side effects. Minor side effects are common during the hair removal treatment. The lasers used during the treatment may cause temporary discomfort immediately after the procedure. The client may get redness, <a href="https://www.drvenus.in/pigmentation-treatment/"rel="noopener noreferrer"class="text-blue-600 underline"> pigmentation changes </a> changes or skin irritation at the treatment area. However, these signs disappear within a few hours. The treatment rarely causes other skin issues like blistering, scarring, skin crusting or changes in the texture of the skin.<span class:"text-2xl"> Note : </span>Laser hair removal treatment is not recommended for eye area as there’s a high possibility of severe eye injury.
        </p>

        <h2 class="text-2xl text-green-900">FAQs</h2>
        <p><strong>1.  Does the treatment removes unwanted hair permanently?</strong><br/>
        The laser hair removal treatment in Hyderabad at Dr. Venus is proven to be an effective method to remove unwanted hair permanently. If done rightly by an expert doctor, the laser treatment destroys hair’s stem cells, making it permanent solution for preventing further hair growth.</p>

        <p><strong>2. Does laser hair removal treatment hurt?</strong><br/>
        Laser hair removal treatment is actually a painless treatment. Generally, it is considered to be a pleasant therapy than waxing, threading or epilating. Most people do not require any numbing creams during the laser treatment. However, the discomfort associated with the treatment depends of the client’s skin type, body part where the treatment is performed, thickness of the hair, equipment used to remove the hair etc.</p>

        <p><strong>3. How do I prepare for laser hair removal?</strong><br/>
       In order to begin the treatment, you will need to allow the hair grow normally, without bleaching. Prior to the treatment, stop beauty parlour activities such as waxing or shaving for 10 days. Avoid makeup while going for the treatment session.</p>

        <p><strong>4.  What are the aftercare tips?</strong></p>
      ...
      <p class="text-sm">
         Our clinic locations are in Chandanagar, Kondapur and Tolichowki which is 15 minutes drive from Kukatpally, Gachibowli, Miyapur and   Hi-Tech City; 20 minutes drive from Jubilee Hills and Banjara Hills. So, what are you thinking of…! Don’t waste your time book an   appointment with us.
      </p>

        <h2 class="text-xl text-green-900">Laser Hair Removal Treatment Cost in Hyderabad</h2>
        <p>
    ...
    },
    {
        ...
        description: "Advanced laser technology to fade unwanted tattoos.",
        content: `
    <h2 class="text-xl text-green-900">Tattoo Removal in Hyderabad</h2>
    <p>
    ...
    <h3 class="text-xl text-green-900">Do you Like Tattoos? Here are some Facts about Tattoos you must Know Before you start Liking Them.</h3>
    <p>
    ...
    <img 
      src="https://www.drvenus.in/wp-content/uploads/2022/11/Tattoo-removal-in-hyderabad-1.jpg" 
      alt="Laser Tattoo Removal Treatment" 
      style="width:100%; margin:20px 0; border-radius:8px;"
    />

    <h3 class="text-xl text-green-900">What Everybody Ought To Know about Tattoos</h3>
    <p>
      ...
      <iframe 
       ...
       <h3 class="text-xl text-green-900">Tattoo Removal Cost in Hyderabad</h3>
       <p>
        To know the tattoo removal cost, just fill the inquiry form we’ll get back to you.
       </p>

       <h3 class="text-lg text-green-900">11 Things No One Ever Told You About Tattoos :</h3>
  ...
  `,
    ...
    },
    {
        ...
        <img src="https://www.drvenus.in/wp-content/uploads/2022/11/Skin-whitening-min.jpg"  alt="Skin Lightening Treatment"class="mt-4"  />

        <h1 class="text-xl text-green-900 mt-4">Skin Whitening Treatment Cost in Hyderabad</h1>
        <p>
        ...
        <h1 class="text-lg text-green-900 mt-4">Advantages of Laser Toning</h1>
        ...
        <h2 class="text-xl text-green-900">Why Choose Us?</h2>
       ...
       <li>We prioritize our clients and ensure that every individual receives the best service. Our commitment is reflected in a client satisfaction rating of 91% and above.</li>
        ...
        <h2 class="text-xl text-green-900">FAQ’s</h2>
        
        <h2 class="text-lg text-gray-800">1.How many sessions are required and what is the duration of each session?</h2>
        <p> 
        ...
        <h2 class="text-lg text-gray-800">2. Is it safe and does it cause any pain?</h2>
        <p>
        ...
        <h2 class="text-lg text-gray-800">3. Which parts of the body can be treated with this?</h2>
        <p>
       It is not just the face but the underarms, feet, hands and even the lips can also be treated.
        </p>

        <h2 class="text-lg text-gray-800">4. Will the change be obvious after treatment?</h2>
        ...
        <h2 class="text-lg text-gray-800">5.What are the side effects?</h2>
        <p>Absolutely none except a mild redness which goes away after fifteen minutes.</p>
        <h2 class="text-lg text-gray-800">6. What standards are being followed?</h2>
    ...
    },
    {
        ...
        content: `
        <h2 class="text-xl text-green-900">Laser Pigmentation Treatment in Hyderabad</h2>
        <p>
       <span class="font-bold">Pigmentation Treatment in Hyderabad :</span> Who doesn’t love a flawless, glowing skin which gives you a ‘feel-good’ effect? Having an even complexion is one of the most sought-after beauty tips to retain one’s aesthetic appeal.
        </p>
       ...
       <p class="mt-4">Your beauty concerns are no longer a matter of worry now, because, Dr. Venus offers you the best skin pigmentation treatments under the guidance of highly efficient dermatologists. Our laser pigmentation removal treatments help to heal the skin from discoloration while giving a smooth and healthy skin.</p>
        ...
        <img src="https://www.drvenus.in/wp-content/uploads/2022/11/Pigmentation-min.jpg" alt="Pigmentation Treatment" />

        <h2 class="font-bold">Causes of Skin Pigmentation</h2>
        <p>Uneven skin tone, generally called <a href="https://en.wikipedia.org/wiki/Hyperpigmentation" target="_blank" rel="noopener noreferrer" class="text-blue-600 underline">
        ...
        <ul class="list-disc list-inside">
         ...
         <h2 class="text-xl text-green-900">Laser Pigmentation Treatment Cost in Hyderabad</h2>
         <p>To know the cost just fill the below contact form and we’ll get back to you.</p>
         <h2 class="text-xl text-green-900">Major Pigmentation Concerns</h2>
         <p> <strong>1. Post-Inflammatory Hyperpigmentation :</strong> It occurs when an injury on the skin heals and leaves a skin discolouration behind. Due to the skin inflammation caused by wounds, the color of the inflamed area changes into tan, brown or black. Sometimes, unsuitable cosmetic procedures can also lead to post-inflammatory hyperpigmentation.</p>
         <p><strong>2. Freckles :</strong> Unlike other pigmentation causes, freckles may appear on the skin (mostly on face), due to the excessive exposure to the sun. Though they don’t change the texture of the skin, the freckles appear like flat circular spots in tan or light brown color.</p>
         <p>3. <strong>Age Spots :</strong>Age spots commonly appear on the face or any other body parts that are constantly exposed to the sun. These oval-shaped age spots tend to be small patches, usually tan or slightly brown in color.</p>
         <p><strong>4. Melasma :</strong> This skin disorder appears on the face, typically across the upper cheeks, chin, forehead and upper lip areas. Melasma is called ‘the mask of pregnancy’ or ‘chloasma’ when it occurs in pregnant women.</p>
         <p><strong>5. Post-Acne Pigmentation :</strong> These are, as the name suggests, developed from healed acne wounds. It appears on the face after the pimple outbreaks.</p>
         <p><strong>6. Solar Lentigines :</strong> These are sunspots, appearing typically on the face areas with high sun exposure. They are usually brown in color with no changes in the skin texture. Solar lentigines are darker and irregular than freckles.</P>

        <h2>Pigmentation Treatment on Face</h2>
        <p>It’s possible to fake your skin beautifully with the help of foundations and primers. But do you really want to do so?</p>
        <p>At Dr. Venus, we are proud to provide innovative <a href="https://www.drvenus.in/skin-care-treatment/" target="_blank" rel="noopener noreferrer" class="text-blue-600 underline">
                 treatments</a> to reduce the skin pigmentation, thereby revitalizing the skin texture. From high-tech lasers to topical skincare products, the highly-skilled dermatologists at Dr. Venus make it possible to fight skin pigmentation effectively. With the state-of-the-art facilities, our specially formulated treatments for pigmentation ultimately delivers a brightened complexion.</p>

                 <h3 class="text-2xl font-serif text-primary mb-4">Our Locations</h3>
                    <p class="text-sm">Our clinic locations are in Our clinic locations are in Chandanagar, Kondapur and Tolichowki which is 15 minutes drive from Kukatpally, Gachibowli, Miyapur, Hi-Tech City; 20 minutes drive from Jubilee Hills and Banjara Hills. So, don’t waste your time book an appointment in advance.</p>
...

    {
        ...
        content: `
          <strong>Hair Transplant in Hyderabad:</strong>
          <p>Hair loss causing thinning of hair or baldness is a common problem for men and women alike. While in some,  the <a 
          href="https://www.drvenus.in/hair-loss-treatments/"  target="_blank" rel="noopener noreferrer"class="text-blue-600 underline">
          hair loss treatments</a> are effective at early detection of the problem, there are certain cases which are quite severe where they be of trivial use.</p>
          <p>Depending on the recession of hairline from front backward (<a 
          ...
          Norwood Hamilton grading</a> of baldness) in males, third to the fifth stage of baldness and for females in second or third (Ludwig’s grading)stages of baldness, Hair Transplantation is the most appropriate form of treatment.</p>
          <p>We bring you a reason to smile as you would be in safe hands with its experienced, qualified and accredited hair transplantation team.</p>


         <h1 class="text-3xl text-green-900">Procedure of Hair Transplantation</h1>
         <ul class="list-disc list-inside">
      ...
      <iframe 
        width="100%" 
        height="400" 
        src="https://www.youtube.com/embed/imyyKfnkqkQ?si=_DPbnsIzkHGibEss" 
        title="Tattoo Removal Video"
        frameborder="0" 
        allowfullscreen>
       </iframe>
       </div>
     <h1 class="text-3xl text-green-900">Hair Transplantation Cost in Hyderabad</h1>
     <p>Consult best hair specialist doctor in Hyderabad to know the cost or just fill the below inquiry form we’ll get back to you.</p>
     <h1 class="text-3xl text-green-900">Types of Hair Transplantation</h1>
     <ul class="list-decimal list-inside">
     <li>FUT Hair Transplant</li>
     <li>FUE Hair Transplant</li>
     </ul>
     <h1 class="text-3xl text-green-900">FUT(Follicular Unit Transplantation)</h1>
     <p>In this process, A strip of skin with hair is removed from the donor site(back & sides of the scalp) and it is then
     divided micro-surgically. Follicles are then separated from the donor strip carefully. Once that is done, the grafts are 
     inserted into the pre-cut mini and micro-slits at the recipient area of the scalp.</p>
     <p class="mt-4">This is one process where a large number of grafts (approximately 4000) can be inserted in a single session.
     The survival rate of the transplanted grafts is high and there is minimal wastage. The hair density is greater and this is a worldwide accepted procedure. 
     Above all, this is a swift process and doesn’t consume much time.</p>
     <h1 class="text-3xl text-green-900">FUE(Follicular Unit Extraction) Hair Transplant</h1>
     <p>FUE Hair Transplant in Hyderabad : This is more suitable for small requirement of graft insertion (around 800-1200) and is effective in tight scalps. Here individual follicular units are extracted and inserted in the recipient thinned out areas. There are no sutures or scars involved post this process though it takes time. But on the brighter side, it heals quickly and the process is less invasive causing very less pain.
     </p>
     <img 
      src="https://www.drvenus.in/wp-content/uploads/2022/11/Fue-hair-transplant-in-hyderabad-min.jpg" 
      alt="Laser Tattoo Removal Treatment" 
      style="width:100%; margin:20px 0; border-radius:8px;"
     />
     <ul class="list-decimal list-inside">
     ...
     <h1 class="text-3xl text-green-900">FUE Hair Transplant Cost in Hyderabad</h1>
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
  ...
  <div>
    <img 
      src="https://www.drvenus.in/wp-content/uploads/2022/11/Hair-transplant-For-women-min-150x150-1.jpg " 
      alt="Hair transplant before and after male hairline"
  ...
  <div>
    <img 
      src="https://www.drvenus.in/wp-content/uploads/2022/11/Fue-Hair-transplant-for-women-min-150x150-1.jpg" 
  ...
  <div>
    <img 
      src="https://www.drvenus.in/wp-content/uploads/2022/11/Hair-Transplant-min-150x150-1.jpg" 
