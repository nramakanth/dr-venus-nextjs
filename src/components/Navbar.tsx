...
export default function Navbar() {
  ...
  return (
    <header className="w-full fixed top-0 z-50 pointer-events-none">
      ...
      <div
        className={`w-full bg-[#eaf3ef] border-b border-[#1f4d3a]/5 transition-all duration-500 overflow-hidden pointer-events-auto ${isScrolled ? "max-h-0 opacity-0 transform -translate-y-full" : "max-h-20 opacity-100 transform translate-y-0"}`}
      >
      ...
      <div className="w-full px-4 md:px-6 pointer-events-none flex justify-center">
        <nav
          className={`transition-all duration-500 pointer-events-auto ${isScrolled ? "max-w-6xl w-full mx-auto mt-4 rounded-3xl md:rounded-full bg-white/90 backdrop-blur-lg shadow-2xl py-3 px-8 md:px-12" : "w-full bg-white py-5 px-6"}`}
        >
          <div
