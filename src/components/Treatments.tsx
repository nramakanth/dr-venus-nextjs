...
const treatments = [
    ...
    {
        title: "Acne Removal",
        description: "Advanced clinical procedures for permanent acne scar and spot removal.",
        ...
        <section className="py-10 md:py-16 px-4 md:px-6 bg-white overflow-hidden">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-8 md:mb-12">
                    <h2 className="text-[10px] md:text-[12px] uppercase tracking-[0.4em] font-medium text-primary/80 mb-2 font-sans">Our Expertise</h2>
                    <h3 className="text-xl sm:text-3xl md:text-4xl font-serif text-primary leading-tight">Advanced Clinical Treatments</h3>
                </div>

                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 md:gap-4">
                    {treatments.map((t, i) => (
                        <div key={i} className="group relative aspect-[4/5.5] sm:aspect-[4/5.5] overflow-hidden rounded-2xl md:rounded-[2rem] bg-gray-50 shadow-lg shadow-black/5 hover:-translate-y-1 transition-all duration-700">
                            {/* Base Image */}
                            <Image
                                src={t.image}
                                alt={t.title}
                            ...
                            <div className="absolute inset-0 p-3.5 md:p-5 flex flex-col justify-end z-20">
                                ...
                                <div className="max-h-0 overflow-hidden group-hover:max-h-32 transition-all duration-700 ease-in-out">
                                    ...
                                    >
                                        Details
                                        <svg width="8" height="8" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="4"><path d="M5 12h14M12 5l7 7-7 7" /></svg>
                                    </Link>
                                </div>
                            </div>
                        </div>
