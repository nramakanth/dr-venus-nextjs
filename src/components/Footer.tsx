...
const branches = [
  {
    ...
    address:
      "3rd Floor, SSS SQUARE Building, Opp To Sarath City Capital Mall, Kondapur, HITECH City, Hyderabad, TS 500084.",
    phone: "+91 77779 77027",
    mapUrl:
      "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3806.044629246169!2d78.3660392!3d17.4575779!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb9326b120dcbf%3A0xbc45f6945edefd1!2sDr.%20Venus!5e0!3m2!1sen!2sin!4v1772099728953!5m2!1sen!2sin",
  },
  {
    name: "Chandanagar Branch:",
    title: "Dr. Venus Institute of Skin & Hair",
    address:
      "Door No 104, 2nd Floor, above Khazana Jewellery, Gangaram, Engineers Enclave, Chanda Nagar, Hyderabad, TS 500050.",
    phone: "+91 77779 77027",
    mapUrl:
      "https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3805.27120966839!2d78.3337805!3d17.4945623!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb92895dc3cf6b%3A0x296c1886e753d824!2sDr.%20Venus!5e0!3m2!1sen!2sin!4v1772101019959!5m2!1sen!2sin",
  },
  {
    name: "Toli Chowki Branch:",
    title: "Dr. Venus Institute of Skin, Hair, Lasers & Weight Loss",
    address:
      "1st Floor, above Burger King, Galaxy, Deluxe Colony, Janaki Nagar Colony, Toli Chowki, Hyderabad, Telangana 500008.",
    phone: "+91 77779 77027",
    mapUrl:
      "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3807.190521995723!2d78.41127879999999!3d17.402642099999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb973b12ff30fd%3A0x31d3b9c77159d038!2sDr.%20Venus!5e0!3m2!1sen!2sin!4v1772101059225!5m2!1sen!2sin",
    special: "New!",
  },
];
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-y-12 gap-x-8 md:gap-16">
                ...
                <div className="flex gap-4 pt-2">
                  {[Facebook, Instagram, Youtube, Linkedin].map((Icon, i) => (
                    <a
                      key={i}
                      href="#"
                      className="w-12 h-12 rounded-xl bg-white/5 border border-white/5 flex items-center justify-center hover:bg-accent hover:text-primary transition-all duration-300"
                    >
                      <Icon size={18} />
                    </a>
                  ))}
              ...
              {treatmentCategories.map((cat, i) => (
                <div
                  key={i}
                  className={`${i === 2 ? "col-span-2 lg:col-span-1" : "col-span-1"} flex flex-col items-start text-left`}
                >
          ...
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex flex-col md:flex-row items-center gap-4 md:gap-12">
              ...
              <div className="flex gap-8">
                <Link
                  href="/privacy"
                  className="text-white/70 hover:text-accent text-[10px] uppercase font-bold tracking-[0.2em] transition-colors"
                >
                  Privacy Policy
                </Link>
                <Link
