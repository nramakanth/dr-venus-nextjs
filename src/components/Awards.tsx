        ...
        <section className="pb-4 pt-16 md:pt-24 bg-white overflow-hidden border-t border-primary/5 ">
            <div className="max-w-6xl mx-auto px-6">
                <div className="text-center mb-12 md:mb-20">
                    <h2 className="text-[11px] md:text-[12px] uppercase tracking-[0.4em] font-bold text-primary/80 mb-3 font-sans">Achievements</h2>
                    <h3 className="text-2xl sm:text-3xl md:text-5xl font-serif text-primary italic">Awards and Recognitions</h3>
                </div>
